...
> 状态：1.5（2026-07-16 修订，知识库冻结为十维：题材/流派/创意约束、设定/人物/命名、节拍/场景/技法/追读；作品契约替代题材流派指导；删除恩怨清算档位并建立计划对象到定稿事实的两阶段生命周期，依据任务 07-10-knowledge-taxonomy-governance。1.4 于 2026-07-08 修订恩怨清算五档，作为被 1.5 替代的历史决策保留；1.3 于 2026-07-07 修订五维声明路由；1.2 于 2026-07-04 修订 §4 #2 验收用词；1.1 于 2026-07-02 修订 §5 依赖口径；1.0 于 2026-06-12 作者逐项确认定稿）
> 日期：2026-06-12
...
├── 作品契约/
│   ├── 作品契约.md             # ★ 唯一书级契约真源
│   └── 知识选择记录.md         # 候选、拒绝、自定义与来源证据；不进日常上下文
├── 文风/
...
| 3 | 备料 | 脚本 | 组装 `工作区/本章写作材料.md`：全书近况+要写到的事+事实切片+信息差边界+近章结尾+反复读清单+文风锚点+作品契约所需小节+细纲最终选择的知识切片；**默认用精准片段**（当前卷+上一卷时间线、按编号取账本条目），不回读当前通用书级条目 |
