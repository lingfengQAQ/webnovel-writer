...
if (!command || command === '--help') {
  ...
  console.log('  read-design <ID或名称>                     精读尚未转正的计划对象')
  ...
  console.log('  knowledge-pack --类型=<题材> [--副题材=a,b] [--流派=a,b]  归一书级分类并读取材料')
  console.log('  knowledge-query --维度=<十维之一> --问题=<未决问题>  查询最多三条候选材料')
  console.log('  persist-contract --file=<json>           保存作者确认的作品契约新版本')
  console.log('  persist-design --file=<json>             保存或放弃作者确认的计划对象')
