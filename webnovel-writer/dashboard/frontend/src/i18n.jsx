...
const dict = {
  ...
  'vi': {
    ...
    dashboard: {
      ...
      unresolvedForeshadow: '伏笔 chưa thu hồi', totalForeshadow: 'Tổng cộng', foreshadowUnit: '伏笔',
      pendingForeshadow: '伏笔 chờ thu hồi (Top 20)', content: 'Nội dung', status: 'Trạng thái', plantedCh: 'Chương chôn',
...
export function I18nProvider({ children }) {
  ...
  const value = { locale, setLocale, t: (path) => t(locale, path) }
