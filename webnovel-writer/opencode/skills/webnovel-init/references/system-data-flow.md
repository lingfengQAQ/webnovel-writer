...
`${OPENCODE_PLUGIN_ROOT}/skills/webnovel-query/references/system-data-flow.md` (v5.4)

## 加载方式

```bash
cat "${OPENCODE_PLUGIN_ROOT}/skills/webnovel-query/references/system-data-flow.md"
```
